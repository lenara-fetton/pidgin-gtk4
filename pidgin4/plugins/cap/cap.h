...
/* pidgin4 (M7): the plugin headers replace internal.h and the GTK 2 ones. */
...
static PurplePlugin *_plugin_pointer;
static sqlite3 *_db; /**< The database */

static GHashTable *_buddy_stats = NULL;
static GHashTable *_my_offline_times = NULL;
static gboolean _signals_connected;
G_GNUC_UNUSED static gboolean _sqlite_initialized;
