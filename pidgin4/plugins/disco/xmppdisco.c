...
/*
 * pidgin4 (M7): the protocol side of Pidgin 2's xmppdisco, unchanged (the
 * disco#info/#items IQs go out through prpl-jabber's
 * "jabber-sending-xmlnode" signal and come back through
 * "jabber-receiving-iq"); the window is gtkdisco.c, rewritten for GTK 4.
 */
