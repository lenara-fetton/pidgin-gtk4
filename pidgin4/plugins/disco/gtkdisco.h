...
struct _PidginDiscoDialog {
	...
	GSimpleActionGroup *actions; /**< "disco.add", "disco.register" (row menu). */
	GtkWidget *menu;             /**< The row context menu popover. */
};
...
struct _PidginDiscoList {
	...
	GListStore *model;          /**< The top-level PidginDiscoNodes. */
	GtkWidget *tree;             /**< GtkColumnView over a GtkTreeListModel. */
	GHashTable *services;        /**< XmppDiscoService -> PidginDiscoNode. */
